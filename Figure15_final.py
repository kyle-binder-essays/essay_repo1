...
def get_input_parameters():
    ...
    csv_monthly = cwd + str('\Data\Fama_French\\49_Industry_Portfolios.CSV')
...
def plot_three_panel_chart(row_of_means, row_of_vols, row_of_tstats):
    ...
    fig.suptitle('FIGURE 15: \n Momentum (Lag, Lag-1) Performance for 49 Industry Portfolios: \n 10 Components Per Long/Short Leg, 1974-2021')
