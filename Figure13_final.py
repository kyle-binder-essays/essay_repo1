...
def get_input_parameters():
    ...
    csv_monthly = cwd + str('\Data\Fama_French\\30_Industry_Portfolios.CSV')
    #    df_daily = pd.read_csv(csv_daily,skiprows=9,nrows=24966-9,index_col=0)
    df_monthly = pd.read_csv(csv_monthly, skiprows=11, nrows=582 - 11, index_col=0)
    ...
    num_securities_long_leg = 7
    num_securities_short_leg = 7
...
def plot_three_panel_chart(row_of_means, row_of_vols, row_of_tstats):
    ...
    fig.suptitle('FIGURE 13: \n Momentum (Lag, Lag-1) Performance for 30 Industry Portfolios: \n 7 Components Per Long/Short Leg, 1926-1973')
